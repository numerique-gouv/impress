import { Modal, ModalSize, useToastProvider } from '@openfun/cunningham-react';
      ...
      >
        <Box
          ...
          $css={css`
            ...
            [cmdk-list] {
              overflow-y: auto;
              max-height: ${isDesktop ? '400px' : 'calc(100vh - 358px)'};
            }
          `}
        >
        ...
        {canShare && selectedUsers.length === 0 && !inputValue && (
